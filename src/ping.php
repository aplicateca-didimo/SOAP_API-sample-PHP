...
if (isset($_POST['txtUser'], $_POST['txtPassword']))
{
    ...
    $result = Ping($username, $password);

    $xml = simplexml_load_string($result);

    foreach($xml->children('http://schemas.xmlsoap.org/soap/envelope/')->Body->children('http://aplicateca.didimo.es/')->PingResponse->PingResult as $item)
    {
        $errorCode = (string)$item->ErrorCode;
        $errorDescription = (string)$item->ErrorDescription;
        $xmlResult = (string)$item->Result;
    }
}
...
<html lang="en">
    ...
    <body style="width: 750px;">
        <div style="width: 100%;">
            <table >
                <tr>
                    ...
                    <td style="padding: 10px; border: solid 1px #f00;"><a href="ping.php" style=" color: #f00; text-decoration: none;">Ping</a></td>
        ...
        <div style="width: 100%;">
            <form method="post" action="ping.php" style="width: 100%;">
        ...
        <div style="width: 100%;">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td>
                        <span style="font-weight: bold;">Result: </span><span style="color: #f00;"><?php printr($xmlResult); ?></span>
                    </td>
                </tr>
            </table>
            <hr/>
...
{
    # Method
    $method_invoke_soap_action = "SOAPAction: http://aplicateca.didimo.es/Ping";
    ...
    <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
      <soap:Body>
        <Ping xmlns="http://aplicateca.didimo.es/">
